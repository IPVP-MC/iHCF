...
public class ChatListener implements Listener {
    ...
    /**
     * Checks if a message should be posted in {@link com.doctordark.hcf.faction.struct.ChatChannel#PUBLIC}.
     *
     * @param input the message to check
     * @return true if the message should be posted in {@link com.doctordark.hcf.faction.struct.ChatChannel#PUBLIC}
     */
